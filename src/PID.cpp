...
PIDController<T, U>::PIDController(U p, U i, U d, std::function<T()> pidSource, std::function<void(T output)> pidOutput)
{
  _p = p;
  _i = i;
  _d = d;
 ...
 */
template <class T, typename U>
void PIDController<T, U>::setTarget(T t)
{
  target = t;
}
 ...
 */
template <class T, typename U>
T PIDController<T, U>::getFeedback()
{
  return currentFeedback;
}
 ...
 */
template <class T, typename U>
void PIDController<T, U>::setEnabled(bool e)
{
 ...
 */
template <class T, typename U>
bool PIDController<T, U>::isEnabled()
{
  return enabled;
}
 ...
 */
template <class T, typename U>
T PIDController<T, U>::getProportionalComponent()
{
  return (T) (error * _p);
}
 ...
 */
template <class T, typename U>
T PIDController<T, U>::getIntegralComponent()
{
 ...
 */
template <class T, typename U>
T PIDController<T, U>::getDerivativeComponent()
{
 ...
 */
template <class T, typename U>
void PIDController<T, U>::setMaxIntegralCumulation(T max)
{
 ...
 */
template <class T, typename U>
T PIDController<T, U>::getMaxIntegralCumulation()
{
 ...
 */
template <class T, typename U>
T PIDController<T, U>::getIntegralCumulation()
{
 ...
 */
template <class T, typename U>
void PIDController<T, U>::setInputBounded(bool bounded)
{
 ...
 */
template <class T, typename U>
bool PIDController<T, U>::isInputBounded()
{
  return inputBounded;
}
 ...
 */
template <class T, typename U>
void PIDController<T, U>::setInputBounds(T lower, T upper)
{
  if(upper > lower)
  {
    inputBounded = true;
 ...
 */
template <class T, typename U>
T PIDController<T, U>::getInputLowerBound()
{
 ...
 */
template <class T, typename U>
T PIDController<T, U>::getInputUpperBound()
{
 ...
 */
template <class T, typename U>
void PIDController<T, U>::setOutputBounded(bool bounded)
{
 ...
 */
template <class T, typename U>
bool PIDController<T, U>::isOutputBounded()
{
 ...
 */
template <class T, typename U>
void PIDController<T, U>::setOutputBounds(T lower, T upper)
{
  if(upper > lower)
  {
    outputBounded = true;
 ...
 */
template <class T, typename U>
T PIDController<T, U>::getOutputLowerBound()
{
 ...
 */
template <class T, typename U>
T PIDController<T, U>::getOutputUpperBound()
{
 ...
 */
template <class T, typename U>
void PIDController<T, U>::setFeedbackWrapped(bool wrapped)
{
 ...
 */
template <class T, typename U>
bool PIDController<T, U>::isFeedbackWrapped()
{
 ...
 */
template <class T, typename U>
void PIDController<T, U>::setFeedbackWrapBounds(T lower, T upper)
{
 ...
 */
template <class T, typename U>
T PIDController<T, U>::getFeedbackWrapLowerBound()
{
 ...
 */
template <class T, typename U>
T PIDController<T, U>::getFeedbackWrapUpperBound()
{
 ...
 */
template <class T, typename U>
void PIDController<T, U>::setPID(U p, U i, U d)
{
  _p = p;
  _i = i;
  _d = d;
 ...
 */
template <class T, typename U>
void PIDController<T, U>::setP(U p)
{
  _p = p;
}
 ...
 */
template <class T, typename U>
void PIDController<T, U>::setI(U i)
{
  _i = i;
}
 ...
 */
template <class T, typename U>
void PIDController<T, U>::setD(U d)
{
  _d = d;
}
 ...
 */
template <class T, typename U>
void PIDController<T, U>::setPIDSource(T (*pidSource)())
{
 ...
 */
template <class T, typename U>
void PIDController<T, U>::setPIDOutput(void (*pidOutput)(T output))
{
 ...
 */
template <class T, typename U>
void PIDController<T, U>::registerTimeFunction(unsigned long (*getSystemTime)())
{
